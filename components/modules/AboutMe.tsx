...
import { Briefcase, GraduationCap, Linkedin, Download } from 'lucide-react';
import Button from '../ui/Button';
import SkillEndorsements from './SkillEndorsements';
import { ABOUT_DATA, LINKEDIN_URL, PROFILE_IMAGE_URL, SKILLS_DATA, RESUME_URL } from '../../constants';
    ...
    <div className="max-w-6xl mx-auto px-6 pb-20">
      ...
      <div className="flex flex-col md:flex-row gap-8 items-center md:items-start mb-16 border-b border-slate-800 pb-12">
        <div className="shrink-0">
          <div className="w-40 h-40 md:w-48 md:h-48 rounded-full border-4 border-slate-800 shadow-2xl overflow-hidden bg-slate-800">
            <img
        ...
        <div className="text-center md:text-left flex-grow">
          ...
          <div className="text-xl text-blue-400 font-medium mb-6">Senior Business Analytics Leader</div>
